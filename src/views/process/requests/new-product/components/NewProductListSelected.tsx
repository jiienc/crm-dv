    ...
    const handleConfirmDelete = () => {
        const newNewProductList = newproductList.filter((newproduct) => {
            return !selectedNewProduct.some(
                (selected) => selected.id === newproduct.id,
            )
        })
        setSelectAllNewProduct([])
        mutate(
            {
                list: newNewProductList,
    ...
    return (
        <>
            ...
            >
                ...
                <p>Send message to the following newproduct</p>
                <Avatar.Group
                    chained
                ...
                >
                    {selectedNewProduct.map((newproduct) => (
                        <Tooltip key={newproduct.id} title={newproduct.name}>
                            <Avatar size={30} src={newproduct.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group>
                <div className="my-4">
