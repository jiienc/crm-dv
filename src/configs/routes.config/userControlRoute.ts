...
const userControlRoute: Routes = [
    {
        ...
        component: lazy(() => import('@/views/userControl/accessControl/users/UsersList')),
      ...
      },
      {
        ...
        component: lazy(() => import('@/views/userControl/accessControl/access/Access')),
        authority: [ADMIN, USER],
        meta: {
            pageContainerType: 'contained',
        },
      },
      {
        ...
        component: lazy(() => import('@/views/userControl/accessControl/audittrail/AuditTrailList')),
        authority: [ADMIN, USER],
        meta: {
            pageContainerType: 'contained',
        },
      ...
      },
      {
        ...
        component: lazy(() => import('@/views/userControl/accessControl/hierarchy/Hierarchy')),
        authority: [ADMIN, USER],
        meta: {
            pageContainerType: 'contained',
        },
