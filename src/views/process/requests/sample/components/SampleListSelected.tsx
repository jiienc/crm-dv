    ...
    return (
        <>
            ...
            >
                <p>
                    {' '}
                    Are you sure you want to remove these sample? This action
                    can&apos;t be undo.{' '}
                </p>
            </ConfirmDialog>
            <Dialog
            ...
            >
                ...
                <p>Send message to the following sample</p>
                <Avatar.Group
                    chained
                ...
                >
                    {selectedSample.map((sample) => (
                        <Tooltip key={sample.id} title={sample.name}>
                            <Avatar size={30} src={sample.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group>
                <div className="my-4">
