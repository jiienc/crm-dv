    ...
    const handleConfirmDelete = () => {
        const newAuditTrailList = audittrailList.filter((audittrail) => {
            return !selectedAuditTrail.some(
                (selected) => selected.id === audittrail.id,
            )
        })
        setSelectAllAuditTrail([])
        mutate(
            {
                list: newAuditTrailList,
    ...
    return (
        <>
            ...
            >
                ...
                <p>Send message to the following audittrail</p>
                <Avatar.Group
                    chained
                ...
                >
                    {selectedAuditTrail.map((audittrail) => (
                        <Tooltip key={audittrail.id} title={audittrail.name}>
                            <Avatar size={30} src={audittrail.img} alt="" />
                        </Tooltip>
                    ))}
                </Avatar.Group>
                <div className="my-4">
